...
export default function CreateQuiz({data}) {
  ...
  return (
    <div className='w-2/3 h-screen m-auto max-2xl:w-[80%] max-lg:w-[90%]'>
        <div className='w-full h-[25%] flex flex-col'>
            ...
            <div className='w-full h-1/2 flex items-center'>
                <div className='w-full h-1/2 bg-red-500 rounded-xl flex items-center p-4 gap-3 max-sm:h-[60%]'>
                    ...
                    <h1 className='text-color font-semibold text-xl max-sm:text-lg'>Quiz Oluşturmak için önce Giriş Yapmalısınız!</h1>
                </div>
            </div>
