...
export default function Register() {
  return (
    ...
    <div className="w-[520px] h-[550px] shadow-primary-shadow rounded-lg">
    <form className="form w-full h-full flex items-center flex-col gap-8 " action="">
        ...
        <div className="w-full h-[40%] pt-4 flex flex-col gap-5 items-center justify-start">
            <button className="w-[30%] text-l font-bold py-1.5 px-5 bg-cyan-700 rounded-lg text-white">Kayıt Ol</button>
